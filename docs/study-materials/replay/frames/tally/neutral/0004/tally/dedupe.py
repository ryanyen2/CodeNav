...
def key(row: Row) -> tuple:
    ...
    The date, the amount and the description. The bank's own reference would be
    exact, but half of the exports do not carry one and the ones that do reuse
    them across statements, so it cannot be relied on alone.
    """
