...
transfer, how many months make a payment recurring, and the share of positive
rows that means an export has its signs the other way round. Adding a shop is an
edit to a list.
