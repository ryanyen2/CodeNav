...
class Summary:
    ...
    def text(self) -> str:
        ...
        for period in self.periods:
            ...
            out.append("")
        if self.recurring:
            # Monthly whichever way the spending above is grouped, because that is
            # what recurring means. Said out loud so a weekly summary does not look
            # like it is claiming these come round every week.
            out.append("## Recurring monthly")
            out.append("")
