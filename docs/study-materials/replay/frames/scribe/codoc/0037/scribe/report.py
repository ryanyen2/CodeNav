...
# How much of a note to quote. Enough to tell one from another at a glance; the
# note itself is in the Markdown, which is the point of printing the marker.
NOTE_EXCERPT = 64

# The notes are not capped the way the furniture is. A capped list cannot be read
# against the document, and reading it against the document is what it is for.
