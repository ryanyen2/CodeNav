...
class ParagraphSettings:
    ...
    # Prefixes whose hyphen survives a line break: with "well" listed here,
    # "well-" and "being" rejoin as "well-being" rather than "wellbeing".
    #
    # Empty by default. Which compounds a corpus actually contains is a fact
    # about that corpus, and a list shipped with the program is a guess at it
    # that nobody made deliberately. Name the prefixes your documents need, per
    # document if they differ; scribe.toml carries a list to start from.
