...
# How long a numbered line may be before it is a list item rather than a heading
# is a setting now: see `scribe/settings.py`.


def heading_level(
    text: str, following: str | None = None, settings: Settings = DEFAULTS
) -> tuple[int, str] | None:
